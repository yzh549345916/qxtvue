...
import DYRHDys from '@/components/MSJY/DYRH/DYRHSingleStationChart'
export default {
  ...
  data: function () {
    return {
      ...
      StationSelect: {"name": "呼和浩特市市区,53466", "id": "53466", "hasChildren": false},
      StationIds:"53466",
      myStations:[],
  ...
  methods: {
    ...
    stationChange: function () {
      this.StationIds = this.StationSelect.id;
    },
