  ...
  <v-container fluid>
    ...
    <v-row justify="center" align="center">
      <div class="text-center align-content-center">
        <p>起报时间</p>
        <p>
          <kendo-datetimepicker v-model="selectDateTime"
                                v-on:close="selectClose"
                                :date-input="true"
                                :interval="240"
                                :max="maxDate"
      ...
      <v-col cols="12" sm="6" md="4">
        ...
        >
          ...
          <v-date-picker v-model="mydate" @input="menu1 = false"></v-date-picker>
        </v-menu>
      </v-col>
      <v-col cols="1">
        <v-menu
      ...
      <div class="text-center align-content-center">
        ...
        <kendo-dropdowntree style="width: 150px;" data-source-ref="remoteDataSourceComponent" data-text-field="name"
                            :placeholder="'请选择...'"
                            :filter="'contains'"
...
import {getTodaytimeFormat} from "../../assets/js/getTodaytimeFormat.js"
import {getTomorrowtimeFormat} from "../../assets/js/getTomorrowtimeFormat .js"
...
export default {
  ...
  data: function () {
    return {
      ...
      selectDateTime: getTodaytimeFormat(8),
      maxDate: getTomorrowtimeFormat(0),
    }
  },
  methods: {
    ...
    dqszyb: function (myID) {
      this.$axios
          .get('/getqtzdybAndSk?id=' + myID + '&datatype=' + this.ybysValue.ybId + '&times=' + (new Date((this.mydate+" "+this.time+":00").substring(0,19).replace(/-/g,'/'))).getTime())
          // .get('/GETCS')
          .then(res => {
