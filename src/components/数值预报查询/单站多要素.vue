<template>
  <v-container fluid>
    ...
    >
      <v-container>
        <v-row justify="center" align="center">
          <QtDys :myStationID="stationiD" :myTimeSpan="myTimeSpan"></QtDys>
        </v-row>
      </v-container>
    </v-sheet>
...
<script>
import QtDys from '@/components/数值预报查询/区局方法多要素图表'
...
export default {
  data: function () {
    return {
      ...
      StationSelect: {"name": "呼和浩特,53463", "id": "53463", "hasChildren": false},
  ...
  methods: {
    ...
    selectClose: function () {
      this.stationiD = this.StationSelect.id;
    },
